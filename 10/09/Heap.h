...
private:
	...
	void _reHeapUp(int lastndx /* Write your code here */);
	void _reHeapDown(int rootndx /* Write your code here */);
...
public:
	...
	bool insertHeap(int itemIn /* Write your code here */);
	bool deleteHeap(int &itemOut /* Write your code here */);
};
